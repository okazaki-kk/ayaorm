...
func Generate(from string, fileInspect FileInspect) error {
	...
	_, err = file.WriteString("// Code generated by ayaorm. DO NOT EDIT.\n")
	if err != nil {
		return err
	}
...
func generateDB(packageName string) error {
	...
	_, err = f.WriteString("// Code generated by ayaorm. DO NOT EDIT.\n")
	if err != nil {
		return err
	}
	_, err = f.WriteString(fmt.Sprint("package ", packageName, "\n\n"))
	if err != nil {
		return err
	}
